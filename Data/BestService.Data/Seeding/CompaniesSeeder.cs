            ...
            for (int i = 0; i < 10; i++)
            {
                foreach (var company in companies)
                {
                    companiesList.Add(new Company
                    {
                        ...
                        User = await userManager.FindByEmailAsync(GlobalConstants.CompanyEmail),
                    });
                }
            }
